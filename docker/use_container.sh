...
start_module() {
    ...
    docker compose -f docker/docker-compose-ros-noetic-dev.yaml up -d 
...
stop_module() {
    ...
    # Start docker container
    docker compose -f docker/docker-compose-ros-noetic-dev.yaml down 
}
...
build_module() {
    ...
    docker compose -f docker/docker-compose-ros-noetic-dev.yaml pull 
    docker compose -f docker/docker-compose-ros-noetic-dev.yaml build 
}
