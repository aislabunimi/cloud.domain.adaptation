...
parameters = load_yaml(os.path.join(REPO_ROOT, 'configs', 'produce_pseudo_labels_test_10_scenes.yml'))
...
for scene in parameters['scenes']:
    ...
    experiment_path = os.path.join(RESULTS_PATH, 'pretrain_25k_test_' + scene + '_pseudo_labels')
    ...
    datamodule = FineTuneDataModule(parameters, scene=scene)
